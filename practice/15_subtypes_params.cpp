// ТЕМА 15: Подклас (subtype) може да се ползва като базовия (is-a). Vehicle& / const Vehicle&
// приемат и Car. Копие по стойност реже до базовия тип (slicing). Обратното (базов → производен) не.
#include <iostream>
